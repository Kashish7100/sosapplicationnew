...
class SVIP4Screen extends StatefulWidget {
  const SVIP4Screen({Key? key, required this.isForthPageOpen, required this.toggleForthPage,
    required this.toggleFifthPage}) : super(key: key);

  final bool isForthPageOpen;
  final VoidCallback toggleForthPage;
  final VoidCallback toggleFifthPage;

  @override
  State<SVIP4Screen> createState() => _SVIP4ScreenState();
}

class _SVIP4ScreenState extends State<SVIP4Screen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Align(
      ...
      child: AnimatedContainer(
        ...
        curve: Curves.linear,
        height: widget.isForthPageOpen ? MediaQuery.of(context).size.height * 0.7 : 0,
          ...
          image: DecorationImage(
            image: Image.network(
              ...
              errorBuilder: (context, error, stackTrace) {
                return Image.asset('assets/images/shield/SVIP4.png',
                  fit: BoxFit.cover,);
              },
            ).image,
            fit: BoxFit.cover,
