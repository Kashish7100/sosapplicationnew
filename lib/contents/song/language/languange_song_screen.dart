...
class LanguageSongListScreen extends StatefulWidget {
  const LanguageSongListScreen({Key? key, required this.languageId, required this.languageName}) : super(key: key);

  final int languageId;
  final String languageName;

  @override
  State<LanguageSongListScreen> createState() => _SongBySingerListScreenState();
}

class _SongBySingerListScreenState extends State<LanguageSongListScreen> {
  ...
  void initState() {
    ...
    getSongData(languageId, searchText);
    getLanguageData();
    getCategoryData();
  ...
  void getSongData(languageId, searchText) async {
    try {
      http.Response response = await SongServices.getLanguageSongData(languageId, searchText);
