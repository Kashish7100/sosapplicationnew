...
class CategorySongListScreen extends StatefulWidget {
  const CategorySongListScreen({Key? key, required this.categoryId, required this.categoryName}) : super(key: key);

  final int categoryId;
  final String categoryName;

  @override
  State<CategorySongListScreen> createState() => _SongBySingerListScreenState();
}

class _SongBySingerListScreenState extends State<CategorySongListScreen> {
  ...
  void initState() {
    ...
    getSongData(categoryId, searchText);
    getLanguageData();
    getCategoryData();
  ...
  void getSongData(categoryId, searchText) async {
    try {
      http.Response response = await SongServices.getCategorySongData(categoryId, searchText);
